...
namespace OctavaPrueba.Controllers
{
    public class PaquetesController : Controller
    {
        ...
        public PaquetesController(BdMiradorContext context)
        {
            _context = context;
        }
        ...
        {
            var bdMiradorContext = _context.Paquetes.Include(p => p.IdHabitacionNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdPaquete,NomPaquete,Precio,IdHabitacion,Estado,Descripcion")] Paquete paquete)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPaquete,NomPaquete,Precio,IdHabitacion,Estado,Descripcion")] Paquete paquete)
        {
