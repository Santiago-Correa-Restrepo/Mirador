...
namespace OctavaPrueba.Controllers
{
    public class ClientesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("NroDocumento,IdTipoDocumento,Nombres,Apellidos,Celular,Correo,Contrasena,Estado,IdRol")] Cliente cliente)
        {
